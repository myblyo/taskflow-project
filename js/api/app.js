 ...
 */
import { createTask, deleteTask, fetchTasks, updateTask } from './client.js';
...
function setMobileMenuState(open) {
    ...
    if (mobileMenuToggleBtn) {
        mobileMenuToggleBtn.setAttribute('aria-expanded', open ? 'true' : 'false');
    }
    if (mobileSidebar) {
...
function initMobileMenu() {
    if (!mobileMenuToggleBtn || !mobileMenuOverlay || !mobileSidebar) return;
